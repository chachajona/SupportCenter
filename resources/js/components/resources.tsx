...
import { CommandLineIcon, PuzzlePieceIcon, RectangleGroupIcon, RocketLaunchIcon, UserGroupIcon, WindowIcon } from '@heroicons/react/24/outline';
...
const resources: Array<Resource> = [
    {
        ...
        name: 'Interface',
        description: 'Workflow 的设计，包括 Node 的结构，各类接口，如何与 Handles, Edges 交互，概括为操作界面逻辑。',
        icon: WindowIcon,
        pattern: {
            y: 24,
            squares: [
    ...
    },
    {
        ...
        name: 'Execution',
        description: '详细描述了节点内部脚本的执行逻辑，以及运行过程中产生的数据如何在不同节点之间流转。',
    ...
    },
    {
        href: '/workflow/nodes',
        name: 'Nodes',
        description: '官方公布的 Nodes 清单。探索和发现自定义节点的方法，以满足特定需求和扩展系统功能。',
    ...
    },
    {
        ...
        name: 'Integration',
        description: '探索工作流与外部设施的集成方案，例如利用自然语言处理技术来简化工作流的构建。',
